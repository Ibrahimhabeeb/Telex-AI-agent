...
export const audioSummarizerAgent = new Agent({
  name: 'Audio Summarizer',
  instructions: `
You are an assistant that summarizes audio files.
The user will provide an audio file or a URL to an audio file.
Process the audio and provide a clear, concise summary of its content.
`,
  model: "google/gemini-2.5-flash",
